...
async function main() {
  ...
  const config = {
    baseUrl: args.baseUrl || process.env.FC_BASE_URL || 'http://100.72.97.11:8080/mge/',
    user: args.user || process.env.FC_USER || 'sup',
    password: args.password || process.env.FC_PASSWORD || 'Azsxdc',
