...
public class OrderDTO {
    ...
    private int status;
    @SerializedName("CurrentStatusTypeId")
    private Integer currentStatusTypeId;
    ...
    public Integer getCurrentStatusTypeId() {
        return currentStatusTypeId;
    }

    public void setCurrentStatusTypeId(Integer currentStatusTypeId) {
        this.currentStatusTypeId = currentStatusTypeId;
    }
