...
public class SincronizarProdutosAction implements AcaoRotinaJava {
    ...
    public void doAction(ContextoAcao contexto) throws Exception {
        ...
        if (!config.isAtivo()) {
            contexto.setMensagemRetorno("[ERRO] Integracao Fastchannel nao esta ativa.");
            return;
        }
        ...
        resultado.append("Sincronizacao de produtos concluida.\n")
                .append("Total analisado: ").append(total).append("\n")
                .append("Estoque sincronizado: ").append(syncedStock).append("\n")
                .append("Preco sincronizado: ").append(syncedPrice).append("\n")
