...
public class FastchannelDirectServlet extends HttpServlet {
    ...
    static {
        ...
        services.put("FCAdminSP.syncEstoqueCompleto", new ServiceInfo(FCAdminService.class, "syncEstoqueCompleto"));
        services.put("FCAdminSP.listarTopsPedido", new ServiceInfo(FCAdminService.class, "listarTopsPedido"));
