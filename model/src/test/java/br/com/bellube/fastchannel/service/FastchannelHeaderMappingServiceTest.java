...
public class FastchannelHeaderMappingServiceTest {
    ...
    @Test
    public void resolvesTipNegFromPaymentMethodBeforeConfig() {
        ...
        FastchannelHeaderMappingService.ResolvedHeader resolved = service.resolve(order);
        assertEquals(new BigDecimal(9), resolved.getCodTipVenda());
    }
}
